...
#define UTIL_ADV_TRACE_INIT_CRITICAL_SECTION()                                                     \
    UTILS_INIT_CRITICAL_SECTION() /*!< init the critical section in trace feature */
#define UTIL_ADV_TRACE_ENTER_CRITICAL_SECTION()                                                    \
    UTILS_ENTER_CRITICAL_SECTION() /*!< enter the critical section in trace feature */
#define UTIL_ADV_TRACE_EXIT_CRITICAL_SECTION()                                                     \
    UTILS_EXIT_CRITICAL_SECTION()          /*!< exit the critical section in trace feature */
...
#define UTIL_ADV_TRACE_VSNPRINTF(...)                                                              \
    tiny_vsnprintf_like(__VA_ARGS__) /*!< vsnprintf utilities interface to trace feature */
